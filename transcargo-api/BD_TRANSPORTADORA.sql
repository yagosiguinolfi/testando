...
CREATE TABLE BAIXA_ORDEM_TRANSPORTE (
	ID INT PRIMARY KEY IDENTITY NOT NULL,
	ID_ORDEM_TRANSPORTE INT NOT NULL,
	DATA_CHEGADA DATE NOT NULL
	CONSTRAINT FK_ORDEM_TRANSPORTE FOREIGN KEY(ID_ORDEM_TRANSPORTE) REFERENCES ORDEM_TRANSPORTE(ID),
);